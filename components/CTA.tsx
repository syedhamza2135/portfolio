    ...
    >
      <div className="reveal mx-auto max-w-3xl rounded-sm bg-cta-bg px-7 py-12 text-cta-text sm:px-12 sm:py-16">
        ...
        <a
          ...
          className="mt-8 inline-flex min-h-[44px] items-center rounded-sm bg-cta-text px-6 text-[0.95rem] font-medium text-cta-bg transition-transform hover:-translate-y-0.5"
        >
          Book a 30-min call
        </a>
      </div>
